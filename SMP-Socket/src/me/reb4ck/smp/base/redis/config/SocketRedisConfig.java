...
public final class SocketRedisConfig implements RedisConfig {
    private final ConfigManager<Configuration, Messages, Commands, Inventories> configManager;

    @Inject
    public SocketRedisConfig(ConfigManager<Configuration, Messages, Commands, Inventories> configManager) {
